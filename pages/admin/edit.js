      ...
      {c && (
        <div>
          ...
          <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: 12 }}>
            ...
            <Field label="Decision URL" value={c.decision_url || ''} onChange={v => update('decision_url', v)} single hint="e.g. https://courts.delaware.gov/..." />
          </div>
          ...
          <div style={{ background: C.bg, border: `1px solid ${C.border}`, borderRadius: 8, padding: '12px 16px', marginBottom: 16 }}>
            ...
            <div style={{ fontFamily: F.ui, fontSize: 11, color: C.inkLight, marginTop: 6 }}>Paste this token anywhere in an Explainer body — renders as an expandable inline card.</div>
          </div>
          <div style={{ display: 'flex', gap: 10 }}>
            <SaveBtn onClick={save} saved={saved} />
            <DeleteBtn onClick={remove} />
